...
function TerminalWindow() {
  ...
  return (
    <div className="w-full max-w-lg mx-auto" aria-hidden="true">
      <div className="bg-[#1a1f30] rounded-xl border border-green-500/20 shadow-[0_0_40px_-12px_rgba(34,197,94,0.25)] overflow-hidden">
        <div className="flex items-center gap-2 px-4 py-3 bg-[#22283b] border-b border-green-500/10">
