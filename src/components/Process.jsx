    ...
    <section id="process" className="py-20 md:py-28 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div ref={ref} className="reveal mb-16">
          <p className="font-mono text-green-400 text-sm tracking-widest uppercase mb-3">Process</p>
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 mb-4">
        <span className="font-mono text-sm text-green-400 bg-green-600/10 px-2 py-0.5 rounded">{label}</span>
